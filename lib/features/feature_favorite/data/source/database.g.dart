    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `CityEntity` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` TEXT NOT NULL, `description` TEXT NOT NULL, `icon` TEXT NOT NULL, `temp` REAL NOT NULL, `tempMax` REAL NOT NULL, `tempMin` REAL NOT NULL, `lat` REAL NOT NULL, `lon` REAL NOT NULL)');
...
class _$CityDao extends CityDao {
  ...
  Future<void> deleteCityByName(String name) async {
    await _queryAdapter.queryNoReturn(
        'DELETE * FROM CityEntity WHERE name = ?1',
        arguments: [name]);
  }
